...
describe("Movement in a markdown file", function()
	...
	it("highlights whole h2", function()
		...
		tw.move_down()
		h.assert_highlighted(92, 1, 97, 0)
		tw.move_down()
		h.assert_highlighted(98, 1, 103, 0)
		tw.move_down()
	...
	it("moves out in out of order headings", function()
		vim.fn.cursor(71, 1)
		tw.move_out()
		h.assert_cursor_at(68, 1)
	end)

	it("moves in in out of order headings", function()
		vim.fn.cursor(98, 1)
		tw.move_in()
		h.assert_cursor_at(100, 1)
	end)
end)
